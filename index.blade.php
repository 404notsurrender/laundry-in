...
@section('content')
    <div class="site-blocks-cover" style="background-image: url({{ url('/images/background-image.png') }});" data-aos="fade">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div class="card-box">
                        <h1 class="text-white">Laundry-In</h1>
                        <p class="text-white">Bajumu kotor tapi males keluar? Laundry-In aja!</p>
                        <div class="button-box">
                            <a href="{{ route('login') }}" class="btn btn-gradient">LOGIN</a>
                            <a href="{{ route('register.index') }}" class="btn btn-gradient">Register</a>
                        </div>
                    </div>
                </div>
            </div>
