        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                <div class="login-box-2">
                    ...
                    <?php echo Form::open(['method' => 'post', 'route' => ['register.store'], 'enctype' => 'multipart/form-data']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="whatsapp" class="form-control" placeholder="Whatsapp" value="<?php echo e(old('whatsapp')); ?>">
                                    <i class="text-danger"><?php echo e($errors->first('whatsapp')); ?></i>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <i class="text-danger"><?php echo e($errors->first('gender')); ?></i>
                                </div>
                            </div>
                            <div class="col-md-6 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <i class="text-danger"><?php echo e($errors->first('birthday')); ?></i>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="address" class="form-control" rows="5"><?php echo e(old('address')); ?></textarea>
                                    <i class="text-danger"><?php echo e($errors->first('address')); ?></i>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <i class="text-danger"><?php echo e($errors->first('google_map')); ?></i>
                                </div>
                            </div>
                            <div class="col-md-12">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florentynasenjoyo/Desktop/web-f03146/resources/views/auth/register.blade.php ENDPATH**/ ?>