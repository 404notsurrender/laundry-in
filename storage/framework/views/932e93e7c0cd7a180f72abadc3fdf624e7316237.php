            ...
            <div class="col-sm-12 col-md-12 col-lg-12 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                <div class="login-box-2">
                        <div class="login-title">
                            <h2 class="text-center">Register Shop</h2>
                        </div>
                    <?php echo Form::open(['method' => 'post', 'route' => ['shop.store'], 'enctype' => 'multipart/form-data']); ?>
                    ...
                    <?php echo csrf_field(); ?>
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-12">
                                <a href="<?php echo e(route('shop.login')); ?>" class="btn btn-outline-primary btn-block btn-lg">Login</a>
                            </div>
                        </div>
                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florentynasenjoyo/Desktop/web-f03146/resources/views/shop/register.blade.php ENDPATH**/ ?>