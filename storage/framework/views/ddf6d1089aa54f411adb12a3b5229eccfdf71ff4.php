        ...
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12 mb-4 mb-lg-0" data-aos="fade" data-aos-delay="">
                <div class="login-box">
                    ...
                    <?php echo Form::open(['method' => 'post', 'route' => ['postlogin']]); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo e(route('register.index')); ?>" class="btn btn-outline-primary btn-block btn-lg">Register</a>
                            </div>
                        </div>
                    <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/florentynasenjoyo/Desktop/web-f03146/resources/views/auth/login.blade.php ENDPATH**/ ?>